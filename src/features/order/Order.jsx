...
// loader fetches order data based on the route param (:orderId)
// useLoaderData accesses the order data returned by the loader

// useFetcher is used to fetch the menu data without triggering a navigation
